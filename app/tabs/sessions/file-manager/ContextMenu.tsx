      ...
      <TouchableWithoutFeedback onPress={onClose}>
        <View className="flex-1 bg-black/50 justify-end">
          <TouchableWithoutFeedback onPress={() => {}}>
            <View className="bg-muted rounded-t-2xl border-t-2 border-x-2 border-border px-4 pt-4 pb-6">
              <View className="flex-row items-center justify-between mb-3">
                ...
                <TouchableOpacity
                  className="bg-background rounded-md p-1 border-2 border-border"
                  onPress={onClose}
                >
              ...
              <View className="gap-2">
                {onView && fileType === "file" && (
                  <TouchableOpacity
                    ...
                    className="flex-row items-center gap-3 p-3 rounded-md bg-card border border-border"
                    activeOpacity={0.7}
                  >
                ...
                >
                  ...
                  <Text className="text-foreground font-medium">Rename</Text>
                </TouchableOpacity>
                ...
                >
                  ...
                  <Text className="text-foreground font-medium">Copy</Text>
                </TouchableOpacity>
                ...
                >
                  ...
                  <Text className="text-foreground font-medium">Cut</Text>
                </TouchableOpacity>
                ...
                {onCompress && (
                  ...
                  >
                    ...
                    <Text className="text-foreground font-medium">Compress</Text>
                  </TouchableOpacity>
                )}
                ...
                {onExtract && isArchive && (
                  ...
                  >
                    ...
                    <Text className="text-foreground font-medium">Extract</Text>
                  </TouchableOpacity>
                )}
                ...
                >
                  ...
                  <Text className="text-foreground font-medium">Delete</Text>
                </TouchableOpacity>
              </View>
            </View>
          </TouchableWithoutFeedback>
