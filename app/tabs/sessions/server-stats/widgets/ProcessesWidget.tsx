...
export const ProcessesWidget: React.FC<WidgetProps> = ({ metrics, isLoading }) => {
  // Process metrics not yet in ServerMetrics type
  ...
  return (
    ...
    >
      ...
      <View style={styles.metricRow}>
        <Text style={[styles.value, { color: '#EC4899' }]}>N/A</Text>
