...
export const UptimeWidget: React.FC<WidgetProps> = ({ metrics, isLoading }) => {
  // Uptime metrics not yet in ServerMetrics type
  ...
  return (
    ...
    >
      <View style={styles.header}>
        ...
        <Text style={styles.title}>System Uptime</Text>
      </View>

      <View style={styles.metricRow}>
        <Text style={[styles.value, { color: '#06B6D4' }]}>N/A</Text>
