...
export const NetworkWidget: React.FC<WidgetProps> = ({ metrics, isLoading }) => {
  // Network metrics not yet in ServerMetrics type
  ...
  return (
    ...
    >
      ...
      <View style={styles.metricRow}>
        <Text style={[styles.value, { color: '#8B5CF6' }]}>N/A</Text>
